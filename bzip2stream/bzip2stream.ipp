...
basic_bzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::basic_bzip2_streambuf(ostream_reference ostream_,
...
template <
    ...
    typename ByteAT>
basic_bzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::~basic_bzip2_streambuf()
{
    flush();
    m_ostream.flush();
...
int basic_bzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::sync()
{
...
typename basic_bzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::int_type
basic_bzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::overflow(typename basic_bzip2_streambuf<Elem, Tr, ElemA, ByteT, ByteAT>::int_type c)
{
...
bool basic_bzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::bzip2_to_stream(typename basic_bzip2_streambuf<Elem, Tr, ElemA, ByteT, ByteAT>::char_type* buffer_,
...
std::streamsize basic_bzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::flush()
{
    std::streamsize written_byte_size = 0, total_written_byte_size = 0;
...
basic_unbzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::basic_unbzip2_streambuf(istream_reference istream_,
    size_t verbosity_,
    bool small_,
...
size_t basic_unbzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::fill_input_buffer()
{
...
void basic_unbzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::put_back_from_bzip2_stream()
{
...
template <
    ...
    typename ByteAT>
basic_unbzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::~basic_unbzip2_streambuf()
{
...
std::streamsize basic_unbzip2_streambuf<
    Elem, Tr, ElemA, ByteT, ByteAT>::unbzip2_from_stream(char_type* buffer_,
    std::streamsize buffer_size_)
{
