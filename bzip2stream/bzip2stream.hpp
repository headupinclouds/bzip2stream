...
class basic_bzip2_streambuf : public std::basic_streambuf<Elem, Tr>
{
public:
...
template <
    ...
    typename ByteT = char,
    typename ByteAT = std::allocator<ByteT>>
class basic_unbzip2_streambuf : public std::basic_streambuf<Elem, Tr>
{
public:
...
template <
    ...
    typename ByteT = char,
    typename ByteAT = std::allocator<ByteT>>
class basic_bzip2_ostream : public basic_bzip2_ostreambase<Elem, Tr, ElemA, ByteT, ByteAT>,
...
template <
    ...
    typename ByteT = char,
    typename ByteAT = std::allocator<ByteT>>
class basic_bzip2_istream : public basic_bzip2_istreambase<Elem, Tr, ElemA, ByteT, ByteAT>,
...
#include <bzip2stream/bzip2stream.ipp>
